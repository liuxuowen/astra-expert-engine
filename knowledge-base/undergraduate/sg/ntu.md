# 南洋理工大学（Nanyang Technological University）本科招生详解

| 字段 | 内容 |
|------|------|
| 适用人群 | 高中生、家长 |
| 适用场景 | 新加坡本科申请 · NTU 院校研究 |
| 录入方式 | 专家整理沉淀（官方 prospectus） |
| 录入时间 | 2026-04 |
...
- **QS 排名**：亚洲第 3（QS Asia University Rankings）；世界第 12（QS World University Rankings）
- **特色标签**：研究密集型、多元文化、创业生态
- **最大亮点**：9/10 毕业生在毕业 6 个月内就业
...
| 学院 | 代表专业 |
|------|----------|
| **Computing and Data Science** | 计算机科学、数据科学与 AI、AI 与社会 |
| **Engineering**（5大院系）| 材料工程、电气与电子工程、土木与环境工程、化学与生物化学工程、机械与航空工程 |
| **Business School（Nanyang Business School）** | 会计、商业分析、商业（单/双学位）、应用计算金融 |
| **Humanities, Arts & Social Sciences** | 艺术设计媒体、人文、社会科学、传播与信息 |
| **Science** | 亚洲环境、生物科学、物理与数学科学、化学与生物化学 |
| **Lee Kong Chian Medicine（LKCMedicine）** | 5年制 MBBS（医学与外科学士） |
| **National Institute of Education（NIE）** | 双学位教育项目（学科+教育）、体育科学与管理 |
| **Honours College** | 荣誉学院，整合所有 Signature Programme 学生 |

### 特色项目（Signature Programmes）
...
| 奖学金 | 福利 |
|--------|------|
| NTU President Award（NEW!）| 免bond；S$10,000 一次性补贴；4年宿舍全额补贴；额外 S$10,000 海外旅行补贴；保证进 Honours College |
| Renaissance Engineering Programme Scholarship | 全额学费 + 生活补贴 + 住宿 |
| Turing AI Scholars Programme Scholarship | 全额学费 + 住宿 |
| CN Yang Scholars Programme Scholarship | 全额学费 + 住宿 |
| NBS Global Leaders Programme Scholarship | 全额学费 + 住宿 |
| Nanyang Global Scholarship（NEW!）| 全额学费 + 生活补贴 |
| ASEAN Undergraduate Scholarship | 东南亚区域全额学费 |
| NTU Talent Scholarship | 全额学费；S$6,500/年生活补贴；S$2,000/年住宿补贴；S$2,000电脑补贴 |
| NTU Science and Technology Undergraduate Scholarship | 科技类专项 |

**申请方式**：与入学申请同一 portal，截止日期相同。
...
| 专业方向 | 参考分数 |
|----------|----------|
| 热门专业（CS、工程类、商科）| 通常需要高中成绩优秀（具体分数因专业而异）|
| 一般专业 | 需提交会考 / 高中成绩；竞争性选拔 |

### 英语水平要求（针对母语非英语学生）

| 考试 | 要求 |
|------|------|
| 雅思 IELTS | 总分 6.0 以上（单项不低于 5.5）建议达到 6.5 |
| 托福 TOEFL iBT | 总分 90 以上 |
| 多邻国 Duolingo | 通常要求 120 以上 |

*注：新加坡授课语言为英语，大部分学生需提供英语水平证明*
...
- **住宿**：25 个 Hall of Residence；单人间/双人间/加大单人间；含空调和非空调选项
- **学生组织**：230+ 个学生社团
- **海外学习**：与 350+ 所合作伙伴院校合作，覆盖 40+ 国家；可进行学期交换、短期项目、实习
- **职业发展**：Career & Attachment Office（CAO）每年提供 30,000+ 实习和就业机会
- **Co-op/实习**：与 200+ 企业合作（含阿里巴巴、Delta Electronics、Saab 等实验室）
...
- 9/10 毕业生在毕业 6 个月内就业
- 合作企业包括 MNCs、SMEs 和公共机构

---

**关联话题**：[[新加坡本科申请]] [[NTU]] [[REP]] [[CNYSP]] [[TAISP]] [[NGL]] [[奖学金]] [[新加坡留学]]
